...
word="Abhilash"
vowel=['a','e','i','o','u']
Result=word.split("").filter((n1)=>vowel.includes(n1.toLowerCase()))
console.log(Result);
...
str="day"
 output=products.filter((num)=>num[1].toLowerCase().includes(str.toLowerCase()))
if(output.length>0){
  console.log(output.map((n1)=>n1[1])); 
}
else{
    console.log("No product are availble");
}
